...
const EquipmentStatusForm = () => {
  ...
  const statusOptions = ['Produção', 'Indisponível', 'Danificado', 'Disponível', 'Manutenção'];
  const defectOptions = ['Engine', 'Carcaça', 'Tela', 'Comunicação', 'Configuração', 'Não Liga'];
    ...
    <div className="relative w-screen h-screen flex bg-gray-100 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col flex-1 items-center justify-between h-full p-4 text-white max-w-full overflow-y-auto mt-5">
        <div className="max-w-4xl text-white p-6 space-y-4">
          ...
          <div>
            <p className="font-semibold text-[24px] text-center">Status Atual: Produção</p>
          </div>

          <div>
            <label className="block mb-2 font-semibold">Informe novo status</label>
            <select
          ...
          {status === 'Danificado' && (
            <>
              <div>
                <label className="block mt-4 mb-2 font-semibold">Selecionar defeito</label>
                <select
                  className="w-full p-2 rounded text-[#00ABAD]"
                  value={defectType}
              ...
              <div>
                <label className="block mt-4 mb-2 font-semibold">Intensidade do dano</label>
                <select
                  className="w-full p-2 rounded text-[#00ABAD]"
                  value={intensity}
          ...
          <div>
            <label className="block mt-4 mb-2 font-semibold">Notas do Equipamento</label>
            <textarea className="w-full p-2 text-[#00ABAD] rounded" rows={3}></textarea>
          </div>
