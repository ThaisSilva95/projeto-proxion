...
function SelectEquipment() {
  ...
  useEffect(() => {
    ...
    const fetchModelos = async () => {
      ...
      try {
        const url = `/api/equipamentos/modelos?modelo=${encodeURIComponent(
          tipoSelecionado
        )}`;
  ...
  useEffect(() => {
    ...
    const fetchNumerosSerie = async () => {
      ...
      try {
        const url = `/api/equipamentos/series?tipo=${encodeURIComponent(
          tipoSelecionado
        )}&modelo=${encodeURIComponent(modeloSelecionado)}`;
